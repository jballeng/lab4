...
data_linechart = [go.Scatter(x=line_df['date'], y=line_df['average_max_temp'], mode='lines', name='month')]
...
app.layout = html.Div(children=[
    ...
    html.Div('This bar chart represent the number of Gold medals between countries'),
    dcc.Graph(id='graph2',
              figure={
                  'data': data_barchart,
                  'layout': go.Layout(title='Number of gold medals',
                                      xaxis={'title': 'Countries'}, yaxis={'title': 'Gold Medals'})
              }
              ),
    html.Hr(style={'color': '#7FDBFF'}),
    html.H3('Stack bar chart', style={'color': '#df1e56'}),
    html.Div(
        'This stack bar chart represent the medal breakdown for the top 20 countries with the most medals'),
    dcc.Graph(id='graph3',
              figure={
                  'data': data_stackbarchart,
                  'layout': go.Layout(title='Olympic medal breakdown for top 20 countries',
